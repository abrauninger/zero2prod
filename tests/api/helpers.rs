...
impl TestApp {
    ...
    /// Extract the confirmation links embedded inthe request to the email API.
...
impl TestUser {
    ...
    async fn store(&self, pool: &PgPool) {
        ...
        let password_hash = Argon2::new(
            Algorithm::Argon2d,
            Version::V0x13,
            // Match the exact parameters of the default `expected_password_hash` in source/routes/newsletters.rs
